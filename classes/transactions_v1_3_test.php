				...
				if (!$con)
				  ...
				  else
				  {
					...
					echo "</div>";
						...
						/*echo "<select name='brandId_manufact' id='brands_manufact'  style='overflow:hidden;width:100%; padding:10px;' 
						class='myselect'>";
...
$counter=0;
						...
						echo "</div>
						<div style='padding:5px; margin-top:15px; width:98%; height:44%; margin-left:auto; margin-right:auto;' class='defect_div' id='defect_details'>
						Λεπτομέρειες βλάβης
						</div>";
...
// $con = mysql_connect("db13.grserver.gr", $this->user, $this->password);
				...
				//	}
						...
						//echo "<h3> Κατηγορία :";
						echo "<div  style='font-size: 1.5vw; overflow-y:scroll; height:320px; padding-right:20px;' class='style-4'> ";	
...
<input type='text' class='hover'  value='".$row['brand']." ".$row['model'].", Έτος κυκλοφορίας : ".$row['prod_year'].", Κωδικός κινητήρα : ".$row['engine_serial']."' readonly onClick='document.getElementById(".$row["modelid"].").submit();'>			
