...
define('SECRET_SALT','LW38OdfdBDHCTES-P7LzWqtu5oIyfXql');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','anipcron@gmail.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','db36.grserver.gr:3306');
define('DBNAME','osticket');
define('DBUSER','acheron');
define('DBPASS','xrt966@@');
