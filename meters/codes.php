...
$defects=new transactions();
$defects->setdb($db);
$defects->setUser($user);
$defects->setPassword($password);
?>
<doctype html>
<html>
<head>
	...
	<div class="wrapper">
		...
		<div class="meter">
			<div class="meterInner metal">
				<span class="needle"  ><span class="needleInner"></span></span>
				<ul class="ticks">
					<li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li>
				</ul>
				<div class="speedWrapper"><span class="speed"><?php $defects->get_number_of_defects(3); ?></span><span class="speedMeasure">βλαβες</span></div>
			</div>
		</div>
