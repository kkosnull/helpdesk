				...
				if (!$con)
				  ...
				  else
				  {
					...
					//echo $init_check;
						...
						if ($ipsfound1==0 && $adminflag==0 && $usertype=="subscriber"){
						?>
                ...
                <form action='#' method='post' onmouseover='checkvalue();'>
                    <ul>
						...
						<?php 
						 ...
						 else if ($ipsfound1!=0 && $ipsfound1<4) {
						
						$login->login();
						}
						else if  ($ipsfound1!=0 && $ipsfound1>3){
						header("Location:http://aniphelpdesk.com/iplock.php");
						}
						
						else if  ($ipsfound1==0 && $adminflag==0){
						$login->login();
						}
						else  if ($adminflag==1) {
						$login->admin_login();
            ...
            <div id="login" class="form-action show">
                ...
                <form action="#" method="post">
                    <ul>
						...
						<li>
                            <h2><a href="change_password.php" style="color:#fff;">Ξέχασα τον κωδικό μου.</a></h2>
							<br>
                        </li>
                        <li>
