...
if (today >= 9 && today <= 16) {
   ...
   document.getElementById("heading_title").innerHTML="Η υπηρεσία λειτουργεί καθημερινά Δευτέρα εώς Παρασκευή και ώρες 9:00 με 17:00";
...
if (today >= 9 && today <= 16) {
   ...
   document.getElementById("heading_title").innerHTML="Услугата работи ежедневно от понеделник до петък от 09:00 до 17:00 часа";
//document.getElementById("login-button").style.display = "none";
   }
