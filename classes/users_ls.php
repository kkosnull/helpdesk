				  ...
				  else
				  {
					...
					// login
						...
						$_SESSION['expire']=time(); + (30 * 60);
							  		...
							  		if ($pcs<3){
							//$pcs_increment=$pcs+1;
							//$sql_increment="UPDATE `helpdesk`.`users` SET `pcs`=".$pcs_increment." WHERE `id`=".$user_id."";
						//mysql_query($sql_increment, $con);
						...
						echo "<script>
								...
								if (typeof(Storage) != 'undefined') {
								   ...
								   alert('Προσοχή!!! Ο φυλομετρητής σας δεν υποστηρίζει html5 localstorage');
								}
								</script>";
						}
...
<br>
<a href='index_ls.php'  style='color:#02A5DC; font-size:1.3em;'>Συνέχεια...</a>
