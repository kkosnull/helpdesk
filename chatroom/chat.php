...
<body style="color:#fff;" oncontextmenu="return false">
    &nbsp;
    <div style="border-right: lightslategray thin solid; border-top: lightslategray thin solid;
        ...
        <table style="width:100%; height:100%; color:#fff;">
            <tr>
                <td colspan="2" style="font-weight: bold; font-size: 16pt; color: #fff; font-family: verdana, arial;
                    text-align: center">
                    Chat room χρηστών</td>
            </tr>
            <tr>
                <td colspan="2" style="font-weight: bold; font-size: 16pt; color: #fff; font-family: verdana, arial;
                    text-align: left">
                    <table style="font-size: 12pt; color: #fff; font-family: Verdana, Arial">
                        <tr>
                            <td style="width: 100px">
                                Name:</td>
                            <td style="width: 100px"><input id="txtname" style="width: 150px;background-color: rgba(0,0,0,0);border: 0px solid; color: #01F4C4; font-size: 12pt;" type="text" name="name" maxlength="15" value="<?php echo $username ?>" readonly /></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td style="vertical-align: middle;" valign="middle" colspan="2">
                    <div style="width: 480px; height: 400px; border-right: darkslategray thin solid; border-top: darkslategray thin solid; font-size: 10pt; border-left: darkslategray thin solid; border-bottom: darkslategray thin solid; font-family: verdana, arial; overflow:scroll; text-align: left;" id="DIV_CHAT" class="scroll_chat">
                    </div>
                </td>
            </tr>
            <tr>
