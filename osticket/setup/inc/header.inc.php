...
<head>
    ...
    <link rel="stylesheet" href="css/wizard.css?ecb4f89">
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/flags.css?ecb4f89">
    <script type="text/javascript" src="../js/jquery-1.8.3.min.js?ecb4f89"></script>
    <script type="text/javascript" src="js/tips.js?ecb4f89"></script>
    <script type="text/javascript" src="js/setup.js?ecb4f89"></script>
</head>
<body>
    <div id="wizard">
        <div id="header">
